...
A bingy mod adding a "Spleengy" goalpack & profile for BingoSync generation and automarking. Goalpack based on Tournament 3 pack, with some subtractions and additions.

The goals in the Spleengy goal pack are: 
2 nail arts
...
All Grubs: Howling Cliffs (1) + Crypts (1)
...
Complete the Crystal Peak Root

Complete the Greenpath Root

Complete the Hive Root
...
Isma's Grove + Howlings Cliffs lore tablets
...
Read both lore tablets in Soul Sanctum

Read Bretta's diary

Read the Kingdom's Edge lore tablet
...
Save the 2 grubs in Kingdom's Edge
...
Save the 7 grubs in Crystal Peak
...
Spire + Pleasure House lore tablets
